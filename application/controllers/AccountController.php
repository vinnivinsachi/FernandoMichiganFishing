	...
	{	
		...
		******************/
		...
		public function ordersAction(){
			...
			$orders = DatabaseObject_Helper_Ordermanager::retrieveOrdersForUser($this->db, $this->signedInUserSessionInfoHolder->generalInfo->userID);
		...
		public function soldordersAction(){
			...
			if($this->signedInUserSessionInfoHolder->generalInfo->user_type=='generalSeller'||$this->signedInUserSessionInfoHolder->generalInfo->user_type=='storeSeller'){
				$itemsSold = DatabaseObject_Helper_Ordermanager::retrieveOrdersForSeller($this->db, $this->signedInUserSessionInfoHolder->generalInfo->userID);
