...
<form method="post" action="{geturl action='login' controller='account'}" id="login-form">
	...
	<legend>Log in to your account</legend>
    	<table>
            <tbody>
                ...
                <tr class="row" id="form_username_container">

                    <td>
                    <label for="form_username">Username:</label></td>
                    <td>
                    <input type="text" id="form_username" name="username" value="{$username | escape}"/></td>
                 </tr>
                 <tr>
                 {include file='partials/error.tpl' error=$errors.username}
                </tr>
				<tr>
                <tr class="row" id="form_password_container">
                	<td>
...
{literal}
	<script src="/htdocs/javascripts/formEnhancer/formEnhancer.js" type="text/javascript"></script>
    
    <script type="text/javascript">
		new formEnhancer('registration-form');
	</script>
