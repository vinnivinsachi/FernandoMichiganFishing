<?php
	...
	class DatabaseObject_Products extends DatabaseObject
	{
		...
		public function __construct($db){
			parent::__construct($db, 'products', 'products_id');
			...
			$this->add('owner_id');
			$this->add('owner_username');
			$this->add('owner_network');
			$this->add('owner_email');
			$this->add('url');
			$this->add('name');	
			$this->add('price');
			$this->add('on_sale');
		...
		protected function preInsert(){
			$this->url= DatabaseObject_StaticUtility::generateUniqueUrl($this->_db, $this->_table, $this->name, $this->owner_id);
			return true;
		}
		
		public function setImageDatabaseTable(){
			$this->image_table='products_images';	
		}
