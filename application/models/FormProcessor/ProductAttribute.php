<?php
	...
	class FormProcessor_ProductAttribute extends FormProcessor
	{
		...
		public function __construct($db, $owner, $product)
		{
			parent::__construct();
			...
			$this->owner_username = $owner->username;
			$this->product_type=$product['product_type'];
			$this->owner_network = $owner->affiliation;
			...
			echo "product_id: ".$product['products_id'];
			$this->product_id = $product['products_id'];
			//if($this->product->load($this->products_id)){
			$this->product_tag = $product['product_tag'];
		...
		public function process(Zend_Controller_Request_Abstract $request)
		{
			...
			if(!$this->hasError())
			{
				...
				$this->product->owner_network = $this->owner_network;
				$this->product->owner_username = $this->owner_username;
				$this->product->owner_email = $this->owner_email;
