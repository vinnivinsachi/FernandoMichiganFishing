...
productPreviewImage.prototype={
	...
	switchImage:function(e){
		element = e.element();
		element.up('.productBox').down('.productFirstImage').innerHTML = element.up('.productIndividualImage').down('.imageLargeAddress').innerHTML;
		
		$A(element.up('.productBox').getElementsByClassName('productIndividualImage')).each(function(value){
